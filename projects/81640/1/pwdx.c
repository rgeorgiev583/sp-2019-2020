...
static char* ERROR_MESSAGE_FEW_ARGUMENTS = "Expected at least one argument.\n";
static int ERROR_CODE_FEW_ARGUMENTS = -1;
static char* ERROR_MESSAGE_READ = "No such process.";
